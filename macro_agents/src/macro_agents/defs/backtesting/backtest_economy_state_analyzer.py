...
class BacktestConfig(dg.Config):
    ...
    backtest_date_start: str | None = Field(
        default=None,
    ...
    backtest_date_end: str | None = Field(
        default=None,
...
@dg.asset(
    ...
    deps=[
        dg.AssetKey(["agent_fred_series_latest_aggregates_snapshot"]),
        dg.AssetKey(["agent_fred_monthly_diff"]),
        dg.AssetKey(["agent_leading_econ_return_indicator_snapshot"]),
        dg.AssetKey(["agent_market_performance_snapshot"]),
        dg.AssetKey(["agent_commodity_performance_snapshot"]),
    ...
    for backtest_date in backtest_dates:
        ...
        try:
            ...
            json_result = {
                ...
                "personality": config.personality,
                "data_sources": {
                    "economic_data_table": "agent_fred_series_latest_aggregates_snapshot",
                    "commodity_data_tables": ["agent_commodity_performance_snapshot"],
                    ...
                    "market_data_tables": ["agent_market_performance_snapshot"],
                },
            ...
            context.log.debug(f"Result for {backtest_date} written to database")
