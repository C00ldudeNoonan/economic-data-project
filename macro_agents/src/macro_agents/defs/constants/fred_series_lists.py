...
labor_market_series = [
    ...
    ("UNEMPLOY", "Unemployed"),
    ("SAHMCURRENT", "Real-time Sahm Rule Recession Indicator"),
...
interest_rates_series = [
    ...
    (
        "DFII10",
        "Market Yield on U.S. Treasury Securities at 10-Year, Inflation-Indexed",
    ),
]
...
fiscal_series = [
    ...
    ("A091RC1Q027SBEA", "Government total expenditures: Interest payments"),
]

# ============================================================================
# MANUFACTURING ACTIVITY (FRED-available proxies for discontinued ISM series)
# ============================================================================
...
manufacturing_activity_series = [
    ...
    ("PCUOMFG", "Producer Price Index by Industry: Total Manufacturing Industries"),
