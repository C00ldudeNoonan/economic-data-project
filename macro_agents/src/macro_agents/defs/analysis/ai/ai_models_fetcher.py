...
def _get_anthropic_models(api_key: str | None = None) -> list[str]:
...
def _get_gemini_models(api_key: str | None = None) -> list[str]:
...
def fetch_available_ai_models(
    ...
    """
    context.log.debug("Environment resolved for model fetcher")
    ...
    try:
        ...
        context.log.warning("Failed to fetch OpenAI models")
    ...
    try:
        ...
        context.log.warning("Failed to fetch Anthropic models")
    ...
    try:
        ...
        context.log.warning("Failed to fetch Gemini models")
