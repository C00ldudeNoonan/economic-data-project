...
def main():
    ...
    series = [("BAMLH0A0HYM2", "High Yield Bond Rate"), ("DJIA", "Dow Jones Industrial Average"), ("DFF", "Federal Funds Effective Rate"),
            ...
            ("EXHOSLUSM495S", "Existing Home Sales") , ("MDSP", "Mortgage Debt Service Payments as a Percent of Disposable Personal Income"), ("MSPUS", "Median Sales Price of Houses Sold for the United States"),
            ("CDSP", "Consumer Debt Service Payments as a Percent of Disposable Personal Income"), ("MEDDAYONMARUS", "Median Days on The Market")
            ,("MEDLISPRIPERSQUFEEUS", "Median Listing Price per Square Feet in the United States"), ("WPUIP2311102", "Producer Price Index by Commodity: Inputs to Industries: Net Inputs to Single Family Residential Construction, Services"),
    ...
    for series_code, series_name in series:
        ...
        upsert_data('fred_data', data, ['date', 'series_code'])
